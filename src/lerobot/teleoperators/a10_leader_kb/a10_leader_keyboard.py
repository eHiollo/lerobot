...
from .config_a10_leaderkb import A10LeaderKbConfig
...
class A10LeaderKb(Teleoperator):
    """
    ...
    config_class = A10LeaderKbConfig
    name = "a10_leader_kb"
    
    def __init__(self, config: A10LeaderKbConfig):
